<?php
    ...
    if(isset($_POST['submit'])){
        ...
        elseif(isset($_POST['nom']) && ($_POST['nom'] != "")){
            $nom = $_POST['nom'];
            $sql = "DELETE FROM employee WHERE nom = '$nom'";
        }
        elseif(isset($_POST['id']) && ($_POST['id'] != "") && isset($_POST['nom']) && ($_POST['nom'] != "")){
            $id = $_POST['id'];
            $nom = $_POST['nom'];
            $sql = "DELETE FROM employee WHERE employeeId = $id AND nom = '$nom'";
        }
        else{
...
<body>
    ...
    <div class="master">
        ...
        <div class="div d3">
            <form class="addForm" action="delete_records.php" method="post">
