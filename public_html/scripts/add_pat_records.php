<?php
    ...
    if(isset($_POST['submit'])){
        if($_POST['nom'] == "" || $_POST['health'] == "" || $_POST['phoneNumber'] == "" || $_POST['address'] ==""|| $_POST['email'] =="" || $_POST['carrier'] == "" || $_POST['sex'] == "" || $_POST['dob'] == ""){
            ...
            if(!ctype_digit($_POST['phoneNumber']) || strlen($_POST['phoneNumber']) > 13 || strlen($_POST['phoneNumber']) < 9 ){
                ...
                $sql = "INSERT INTO patient (patientId, nom, sex, dob, phoneNumber, address, email, carrierNumber, healthCardNumber) VALUES ('NULL','$nom', '$sex', '$dob','$phoneNumber', '$address', '$email', '$carrier' , '$health')";
...
<body>
    ...
    <div class="master">
        ...
        <div class="div d3">
            <form class="addForm" action="add_pat_records.php" method="post">
