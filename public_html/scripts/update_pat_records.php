<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $input = array( "uNom", "uSex","uDOB","uPhone", "uSpecialty", "uAddress", "uEmail","uCarrier","uHealth");
        $names = array( "nom", "sex","dob","phoneNumber","specialty", "address","email","carrierNumber","healthCardNumber");
        $used = array(false,false,false,false,false,false,false,false);
        $submit = array();
        $check = false;
        $id = false;
        $nom = false;
        if(isset($_POST['id']) && $_POST['id'] != ""){
            ...
            $output = "Please enter a patient to search for";
        }
        ...
        if($id == true){
            $sql = $sql . " WHERE patientId = ". $_POST['id'];
       }
...
<body>
    ...
    <div class="master">
        ...
        <div class="div d3">
            <form class="addForm" action="update_pat_records.php" method="post">
                Select the patient by one of the following:
                <input type="text" name="id" placeholder="ID">
                Enter the information you would like changed
                <input type="text" name="uNom" placeholder="Name">
                <input type="text" name="uSex" placeholder="Sex">
                <input type="text" name="uDOB" placeholder="Date of Birth (YYYY-MM-DD)">
                ...
                <input type="text" name="carrier" placeholder="Carrier Number">
                <input type="text" name="health" placeholder="Health Card Number">
